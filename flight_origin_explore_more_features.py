...
from plot_and_util import plot_points_flight_5d

#input_file = 'dist-alt-hdg-speed.20190129.csv'
input_file = 'C:/users/jb3435/documents/analytics_focus_group/dist-alt-hdg-speed.20190129.csv'

time_and_flt = np.genfromtxt(input_file, delimiter='|', usecols=(0,1,2), dtype='str')
aircraft = np.genfromtxt(input_file, delimiter='|', usecols=(3), dtype='str')
rawdata = np.genfromtxt(input_file, delimiter='|', usecols=(4,5,6,7))

wide = ['A306', 'A330', 'A332', 'B744', 'B748', 'B763', 'B764',
        'B772', 'B77L', 'B773', 'B77W', 'B788', 'B789', 'DC10', 'MD11']

narrow = ['A319', 'A320', 'A321', 'B733', 'B737', 'B738', 'B739', 'B752']

regional = ['CRJ2', 'CRJ9', 'CRJ7', 'DH8A',
            'E135', 'E145', 'E170', 'E190', 'E45X']
...
train_idx[np.random.choice(np.arange(alldata_len),
                           size = train_len, replace = False)] = True
...
plot_points_flight_5d(rescale_train_data[:, 0], rescale_train_data[:, 1], 
                      rescale_train_data[:, 2], rescale_train_data[:, 3],
                      title = 'DBSCAN',
                      color_type='explicit', c_pred=dbscan_pred, colormap = None,
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/dbscan.more.grid.png')
...
plot_points_flight_5d(rescale_train_data[:, 0], rescale_train_data[:, 1], 
            ...
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/kmeans3.more.grid.png')
...
plot_points_flight_5d(rescale_train_data[:, 0], rescale_train_data[:, 1], 
            ...
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/kmeans5.more.grid.png')
...
plot_points_flight_5d(rescale_train_data[:, 0], rescale_train_data[:, 1],
            ...
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/affprop.more.grid.png')
...
plot_points_flight_5d(rescale_train_data[:, 0], rescale_train_data[:, 1],
            ...
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/agglom-single.more.grid.png')
...
plot_points_flight_5d(rescale_train_data[:, 0], rescale_train_data[:, 1],
                      ...
                      color_type='explicit', c_pred=agg_pred, colormap = None,
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/agglom-ward.more.grid.png')
...
plot_points_flight_5d(rescale_train_data[:, 0], rescale_train_data[:, 1],
            ...
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/lof-outliers.more.grid.png')
...
plot_points_flight_5d(rescale_train_data[:, 0], rescale_train_data[:, 1],
            ...
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/isoforest-outliers.more.grid.png')
...
plot_points_flight_5d(rescale_train_data[:, 0], rescale_train_data[:, 1],
            ...
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/both-outliers.more.grid.png')
...
plot_points_flight_5d(rescale_no_outliers[:, 0], rescale_no_outliers[:, 1],
                      rescale_no_outliers[:, 2], rescale_no_outliers[:, 3],
                      title = 'DBSCAN no outliers',
                      color_type='explicit', c_pred=dbscan2_pred, colormap = None,
            #colormap=cmap(norm(lof_outlier.negative_outlier_factor_)),
                      file = 'plots/dbscan2.more.grid.png')
